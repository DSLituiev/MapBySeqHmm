...
f = AR.visualizeStat;
fig(f, 'width', 24)
exportfig(gcf, fullfile('figures', dataID,'qualityCtrl'), 'format',GRAPH_EXPORT_TYPE, 'color', 'rgb')
...
z = AR.calcMleZ('plot');
fig(gcf, 'width', 24)
exportfig(gcf, fullfile('figures', dataID, 'zMLE'), 'format',GRAPH_EXPORT_TYPE, 'color', 'rgb')
...
fig(gcf, 'width', 24)
exportfig(gcf, fullfile('figures', dataID,'LogLiOdds'), 'format', GRAPH_EXPORT_TYPE, 'color', 'rgb')
...
fig(gcf, 'width', 24)
exportfig(gcf, fullfile('figures', dataID, 'LH-Posterior'), 'format',GRAPH_EXPORT_TYPE, 'color', 'rgb')
